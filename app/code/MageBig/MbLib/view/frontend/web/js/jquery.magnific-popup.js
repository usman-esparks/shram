    ...
    MagnificPopup.prototype = {
        ...
        open: function(data) {
            ...
            if(mfp.isOpen) {
                if (data.mainClass) {
                    if (mfp.st.mainClass) {
                        mfp.bgOverlay.removeClass(mfp.st.mainClass).removeClass('mfp-ready');
                        mfp.wrap.removeClass(mfp.st.mainClass).removeClass('mfp-ready');
                    }
                    mfp._addClassToMFP(data.mainClass);
                    setTimeout(function () {
