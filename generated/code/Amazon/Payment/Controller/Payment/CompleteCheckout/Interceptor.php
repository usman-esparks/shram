...
class Interceptor extends \Amazon\Payment\Controller\Payment\CompleteCheckout implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $amazonConfig, $cartManagement, $guestCartManagement, $checkoutSession, $session, $pageFactory, $messageManager, $exceptionLogger, $orderInformationManagement);
    }
